...
export default (props) => (
  <SvgContainer class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" name="hdd" width={ props.width || 16 } height={ props.height || 16 } fill={ props.fill || "#666" }>
    <Path d="M786.5 131l-0.1-0.2c-6.5-20.2-25.1-33.8-46.3-33.8L277.9 97c-21.1 0-40.2 14-46.3 34l0 0.1c-0.4 1.3-34.3 122.8-67.7 243.2C96 618.7 96 620.4 96 621.8l0 257.4c0 27 22.1 49 49.2 49L878 928.2c27.1 0 49.2-22 49.2-48.9l0.6-265.3L786.5 131zM864 672l0 193L159.2 865 159.2 672 864 672zM860.6 608.8 162.5 608.8l126.4-448.6 440.3 0L860.6 608.8zM588.4 825.7c17.4 0 31.6-14.2 31.6-31.6l0-51.2c0-17.4-14.2-31.6-31.6-31.6-17.4 0-31.6 14.2-31.6 31.6l0 51.2C556.8 811.5 571 825.7 588.4 825.7zM691.2 825.7c17.4 0 31.6-14.2 31.6-31.6l0-51.2c0-17.4-14.2-31.6-31.6-31.6-17.4 0-31.6 14.2-31.6 31.6l0 51.2C659.6 811.5 673.8 825.7 691.2 825.7zM793.6 825.7c17.4 0 31.6-14.2 31.6-31.6l0-51.2c0-17.4-14.2-31.6-31.6-31.6-17.4 0-31.6 14.2-31.6 31.6l0 51.2C762 811.5 776.2 825.7 793.6 825.7z"
      p-id="5908" />
  </SvgContainer>
)
