...
export default (props) => (
  <SvgContainer class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" name="closesquareo" width={ props.width || 16 } height={ props.height || 16 }
    fill={ props.fill || "#666" }>
